...
# Require uniform bucket-level access on every bucket (no legacy object ACLs). Contact audio is
# the rawest personal data this service reads, and per-object ACLs are how one recording of a
# customer's voice becomes public.
