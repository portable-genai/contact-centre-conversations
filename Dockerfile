# Contact Centre AI (E1) serving image.
#
...
ENV PYTHONDONTWRITEBYTECODE=1 \
    ...
    CONTACT_PROFILE=gcp \
    CONTACT_SETTINGS=/app/config/settings.yaml \
    PORT=8080
...
CMD ["sh", "-c", "exec uvicorn contact_centre_conversations.api.app:app --host 0.0.0.0 --port ${PORT:-8080}"]
