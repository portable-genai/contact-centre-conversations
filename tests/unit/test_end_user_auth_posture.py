...
read
    ...
    bind_profile == local AND profile chosen AND CONTACT_S2S_TOKEN unset
...
approver's groups and tenant, and ``/v1/agent-assist/turn`` with a real deterministic panel
and a real audit record.
...
from contact_centre_conversations.adapters.local.identity import (
    LocalIdentityAdapter,
)
from contact_centre_conversations.adapters.onprem.identity import (
