...
shape ships here: plain Python callables that delegate to the mode services, and a card that
advertises exactly those callables. The MODE GATE applies here too: a tool for a mode this
deployment disabled refuses before it does anything.
